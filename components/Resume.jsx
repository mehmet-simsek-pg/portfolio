      ...
      <div className="py-6">
        ...
        <ul className="list-disc list-outside px-7 py-1 leading-relaxed">
          <li>
            ...
            sharing what I’m learning in web development, specifically front-end
            development.
          </li>
          <li>
            Private 1 on 1 Zoom coaching calls related to web development. More
            specifically debugging, teaching basic web development concepts and
            code reviews.
          </li>
        </ul>
      </div>
      ...
      <div className="py-6">
        ...
        <ul className="list-disc list-outside px-7 py-1 leading-relaxed">
          <li>
            ...
            hose lines, and fire ground operations, ventilation, and search and
            rescue.
          </li>
          <li>
          ...
          <li>
            ...
            Prehospital Trauma Life Support, and Advanced Cardiac Life Support,
            among others.
          </li>
        </ul>
      </div>
